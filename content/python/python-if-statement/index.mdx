...
Here, **_if (condition)_** you will provide the condition to check, if it is fulfilled, code block will be executed (it is called if block) otherwise skipped. Also note that, here parenthesis is optional (not mandatory like java or c++) but I always find them useful like other developers.

## Example of Python if Loop

Let's check out few if statement examples that could be helpful to know more of this statement.

**Example 1:** **_Check a numeric value_**
