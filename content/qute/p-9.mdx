---
title: "Qute Built in Resolvers"
date: "2024-07-23"
slug: "qute-built-in-resolvers"
---
...
<ul style={{listStyleType: "lowerRoman"}}>
  <li>
    <h2>
      <a href="#elvis-operator">Elvis Operator</a>
    </h2>
    <p>
      <b>Description:</b> Outputs the default value if the previous part cannot
      be resolved or resolves to null.
    </p>
  </li>
  <li>
    <h2>
      <a href="#orEmpty">orEmpty</a>
    </h2>
    <p>
      <b>Description:</b> Outputs an empty list if the previous part cannot be
      resolved or resolves to null.
    </p>
  </li>
  <li>
    <h2>
    ...
    <p>
      <b>Description:</b> Shorthand for if-then-else statement. Unlike in If
      Section nested operators are not supported.
    </p>
  </li>
  <li>
    <h2>
      <a href="#logical-and">Logical AND Operator</a>
    </h2>
    <p>
      <b>Description:</b> Outputs true if both parts are not falsy as described
      in the If Section. The parameter is only evaluated if needed.
    </p>
  </li>
  <li>
    <h2>
      <a href="#logical-or">Logical OR Operator</a>
    </h2>
    <p>
      <b>Description:</b> Outputs true if any of the parts is not falsy as
      described in the If Section. The parameter is only evaluated if needed.
    </p>
  </li>
</ul>
...
<PostImage src="https://cdn.codeinjar.com/quarkus/qute/qute-built-in-resolvers/image1.png" alt="qute-tutorial" />
...
<PostImage src="https://cdn.codeinjar.com/quarkus/qute/qute-built-in-resolvers/image2.png" alt="qute-tutorial" />
...
<PostImage src="https://cdn.codeinjar.com/quarkus/qute/qute-built-in-resolvers/image6.png" alt="qute-tutorial" />
...
<PostImage src="https://cdn.codeinjar.com/quarkus/qute/qute-built-in-resolvers/image7.png" alt="qute-tutorial" />
...
<PostImage src="https://cdn.codeinjar.com/quarkus/qute/qute-built-in-resolvers/image3.png" alt="qute-tutorial" />
...
<PostImage src="https://cdn.codeinjar.com/quarkus/qute/qute-built-in-resolvers/image4.png" alt="qute-tutorial" />

Here, in the if section, we have used logical **_AND_** operator to filter the product list. So, we only retrieve the products info that price is not only less than 1000 but also available.
...
<PostImage src="https://cdn.codeinjar.com/quarkus/qute/qute-built-in-resolvers/image8.png" alt="qute-tutorial" />
