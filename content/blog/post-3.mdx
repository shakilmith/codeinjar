...
date: "2024-03-23"
slug: "blog/spring-boot-freemarker-view"
postInfo: "Freemarker is a Java Template engine that helps to generate html pages, emails, configuration files etc. In this post we are going to see how to use Freemarker template engine with Spring Boot."
---
...
Run the app and you will see the simple greeting message if you invoke the uri [http://localhost:8080/greeting](http://localhost:8080/greeting) in your web browser. 

<br/>
<PostImage src="https://cdn.codeinjar.com/blog/spring-boot/spring-boot-freemarker-view/image1.png" alt="Spring Boot Freemarker View" />
<br/>
...
<br/>
<PostImage src="https://cdn.codeinjar.com/blog/spring-boot/spring-boot-freemarker-view/image2.png" alt="Spring Boot Freemarker View" />
<br/>
