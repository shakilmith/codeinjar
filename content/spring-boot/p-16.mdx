---
title: "Thymeleaf Link or URL Expression"
date: "2024-05-30"
slug: "thymeleaf-url-expression"
---
...
You can see, how we have used thymeleaf url expression. The syntax is ```<a th:href="@{/url}" />``` that basically works like a regular url tag means, a tag of html.
...
<PostImage src="https://cdn.codeinjar.com/blog/thymeleaf/thymeleaf-url-expression/img1.png" alt="Spring Boot and Thymeleaf" />
