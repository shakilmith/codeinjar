...
<PostImage src="https://cdn.codeinjar.com/spring-boot/accessing-data-with-jpa/spring-boot-rest-api/image1.png" alt="spring boot"/>
...
<PostImage src="https://cdn.codeinjar.com/spring-boot/accessing-data-with-jpa/spring-boot-rest-api/image2.png" alt="spring boot"/>
...
**Step 13:** Now create controller class in the **src/main/java/com/javaondemand/controller** package **CustomerController.java** and annotate this class by **@RestController** annotation. 

We have to Autowired (somehow Inject) the **CustomerService.java** class here.
