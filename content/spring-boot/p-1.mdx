...
date: "2021-07-23"
slug: "spring-boot-hello-world-example-application"
---
...
For bootstrapping our spring boot project, we will use spring initializer. So, visit here: [https://start.spring.io/](https://start.spring.io/) for bootstrapping our first spring boot application.


<PostImage src="https://cdn.codeinjar.com/spring-boot/spring-boot-hello-world/image1.png" alt="Spring Boot"/>
...
So, Open your favourite browser and type: [http://localhost:8080/hello-world](http://localhost:8080/hello-world) and then you will see the Hello World! String message.


<PostImage src="https://cdn.codeinjar.com/spring-boot/spring-boot-hello-world/image2.png" alt="Spring Boot"/>
