...
```java
int x; //We declare the variable with int data type.
...
Primitive types: int, float, double, long, char, byte, boolean (It is considered built in data types in java)
