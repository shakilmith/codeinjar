...
date: "2024-01-23"
slug: "handling-exception-in-java"
---
...
- Explicitly throw an exception using throw keyword (will be added)
- How to create a custom exception extending the Exception (will be added)
