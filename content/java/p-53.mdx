...
We also have to remember that, data members can be static and non static as well. Static means belong to the class and non-static means belong to the instance of the class. We will describe this topic in different post; [Java Static and Non Static Class Members](/java-static-and-non-static-class-members)
