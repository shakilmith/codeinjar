---
title: "Java Program to Check An Input Letter Is Vowel Or Consonent"
date: "2024-01-07"
slug: "java-examples/check-vowel-and-consonent"
...
**Note:** In case, you can't use logical OR (||) and logical NOT (&&) operator, but can use multiple case block at a time and they treat like logical OR operator.