...
//paragraph writing component
const ParagraphWritingPage = () => {
  return(
    <BlogPostLayout>
...
const ParagraphList=()=>{
  ...
  // Fetch the JSON file and parse it
    const fetchPosts = async () => {
      try {
        const response = await fetch("https://cdn.codeinjar.com/english/paragraph/api/posts.json") // URL to the JSON file
        if (!response.ok) {
